...
const BackToTopButton = () => {
    ...
    return (
        <button onClick={handleScroll}>
            <div className={` ${!btnVisiblity ? "-translate-y-[100vh]" : "translate-y-0"} fixed z-50 bottom-2 right-2 transition-all delay-100 duration-500 w-8 h-8 rounded-full cursor-pointer flex justify-center items-center text-gray-200 bg-orange-400 text-2xl group`}>
